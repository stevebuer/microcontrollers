...
Above is an STM8S003F3P6 (mainstream value line) with the following features:
...
Debugging is apparently supported on Linux/sdcc via openocd, but I have not tried it.

Detailed debuggin info [described here](DEBUGGING.md).
